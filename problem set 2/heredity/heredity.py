...
def normalize(probabilities):
    ...
    for person in probabilities:
        for b in ['gene', 'trait']:
            a = sum(probabilities[person][b].values())
            for category in probabilities[person][b]:
                val = probabilities[person][b][category]
                normalized_val = val / a
                normalized[person][b][category] = normalized_val
    return normalized
